  ...
  return (
    <View style={styles.sectionsContainer}>
      {CATEGORY_REPO.map((group) => {
        ...
        const groupItems = plannedBudgets.filter(
          ...
          >
            <View style={styles.sectionHeader}>
              ...
              <Text style={[styles.sectionTotal, { color: subTextColor }]}>
                {groupTotal > 0
                  ? `${currencySymbol}${groupTotal.toLocaleString()}`
                  : ""}
              </Text>
            </View>
            ...
            {groupItems.map((item) => (
              <View key={item.id} style={styles.budgetRow}>
                <Text style={[styles.budgetLabel, { color: subTextColor }]}>
            ...
            >
              ...
              <Text style={[styles.addCategoryText, { color: themeColor }]}>
