...
export const CATEGORY_REPO: RepoCategoryGroup[] = [
  ...
  },
  {
    ...
    items: [
      {
        code: "TRANS_CAR_COSTS",
        label: "Car costs",
        type: "expense",
        icon: "car-outline",
      },
      {
        code: "TRANS_CAR_INSURANCE",
        label: "Car insurance",
        type: "expense",
        icon: "shield-outline",
      },
